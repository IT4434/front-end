...
import { changeChat, searchMember, watchfetchChatMember, watchfetchChat } from "src/redux/User/Chat/action";
import img from "../../../../assets/images/fantom_logo.png";
import errorImg from "../../../../assets/images/search-not-found.png";
import start_conversion from "../../../../assets/images/start-conversion.jpg";
import { Picker } from "emoji-mart";
import { SEND_MESSAGE_WATCHER, REPLY_MESSAGE_WATCHER, CREATE_CHAT_WATCHER } from "src/redux/User/Chat/actionTypes";

const ChatApp = (props) => {
    const dispatch = useDispatch();
    const allMembers = useSelector((content) => content.Chat.allMembers);
    const chats = useSelector((content) => content.Chat.chats);
    const selectedUser = useSelector((content) => content.Chat.selectedUser);
    const currentUser = useSelector((content) => content.Chat.currentUser);
    const online = useSelector((content) => content.Chat.online);
    const members = useSelector((content) => content.Chat.members);
                                                    ...
                                                    <Col xl="12" className="d-flex">
                                                        ...
                                                        <InputGroup className="text-box">
                                                            ...
                                                            <InputGroupAddon addonType="append">
                                                                <Button color="primary" onClick={() => handleMessagePress("send")}>
                                                                    {"Send"}
                                                                </Button>
                                                            </InputGroupAddon>
                                                        </InputGroup>
                                                ...
                                                <div className="people-list">
                                                    <ul className="list digits custom-scrollbar">
                                                        <li className="clearfix">
                                                            <Media className="rounded-circle user-image" src={img} alt="" />
                                                            <div className="about">
                                                        ...
                                                        <li className="clearfix">
                                                            <Media className="rounded-circle user-image mt-0" src={img} alt="" />
                                                            <div className="about">
                                                                <div className="name">
                                                                    {"VincentPorter"}
                                                                    <div className="status">
